...
def user_dashboard():
    ...
    if user:
        ...
        return render_template("user_dashboard.html", sections=sections, feedback_given=feedback_given, feedback=feedback, user_requests=user_requests, completed_books=completed_books, Book=Book, MAX_BOOK_REQUESTS=MAX_BOOK_REQUESTS, user_requests_count=user_requests_count)
    else:
